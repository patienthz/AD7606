...
#define FRST_Pin GPIO_PIN_10
#define FRST_GPIO_Port GPIOA
#define ST_A_Pin GPIO_PIN_11
#define ST_A_GPIO_Port GPIOA
#define ST_B_Pin GPIO_PIN_12
#define ST_B_GPIO_Port GPIOA
